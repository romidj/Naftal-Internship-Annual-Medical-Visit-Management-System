...
function InfoPatient() {
    ...
    // Correctly destructure employeeId from useParams
    ...
    useEffect(() => {
        console.log("Employee ID from URL:", employeeId); // Check if employeeId is correct
        if (employeeId) {
    ...
    return (
        <Layout>
            ...
            <div className="MedHeader">
                        ...
                        <NavLink className="NavMed" to={`/DemandeAnalyse/${employeeId}`}>Demande d'analysesn</NavLink>
                        <div className="logo">
                            <img src={Logo} alt="" />
                        </div>
                    </div>

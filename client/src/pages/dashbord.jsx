...
const Dashbord = () => {
  ...
  return (
    <Layout>
      <h1 className="bienvenue">Bienvenu cher Infermier ...</h1>
      <div className="d_container">
        <div className="dashbord">
          <div className="sent_convos">
            <div className="title">
              <FontAwesomeIcon className="icon-info" icon={faEnvelopeCircleCheck} />
              Convocation envoyés
            </div>
            <p>{dashbord.total_sent_convocations}/{dashbord.total_employees}</p>
          </div>
